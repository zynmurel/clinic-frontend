...
const Page = async () => {
    return (
        <div className="bg-gradient-to-r from-amber-50 to-white lg:w-full max-w-5xl md:grid-cols-2 grid p-5  lg:grid-cols-5 rounded-2xl shadow bg-white z-10">
            <div className=" lg:col-span-3 hidden md:flex flex-col p-10 justify-center items-center gap-2 rounded-lg">
                <Image
                    ...
                    width={350}
                    height={250}
                    className=" object-cover w-full h-auto lg:px-16 "
                />
